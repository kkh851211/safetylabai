...
export function KioskAccessResultScreen() {
  ...
  return (
    ...
    >
      ...
      {/* Checkmark Icon Area - y=200 to y=700 */}
      <div
      ...
      {/* Main Content Area - y=700 to y=1200 */}
      <div
      ...
      >
        ...
        <div className="flex flex-col items-center gap-2 mt-12 bg-white/30 backdrop-blur-md px-16 py-10 rounded-[40px] border border-white/20 shadow-xl shadow-green-900/5">
          <p
      ...
      {/* Countdown Area - y=1700 to y=1920 */}
      <div
        className="absolute left-0 w-[1080px] flex items-center justify-center"
      ...
      >
        <div className="bg-white/40 backdrop-blur-sm px-10 py-5 rounded-full border border-white/20">
          ...
          >
            <span className="font-bold text-blue-600 mr-2">{countdown}</span>초 후 처음 화면으로 돌아갑니다
          </p>
        </div>
      </div>
    </div>
